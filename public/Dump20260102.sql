...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-12-02 14:03:25',NULL),('diagnostics.include_raw','OFF','2025-12-02 14:03:25',NULL),('ps_thread_trx_info.max_length','65535','2025-12-02 14:03:25',NULL),('statement_performance_analyzer.limit','100','2025-12-02 14:03:25',NULL),('statement_performance_analyzer.view',NULL,'2025-12-02 14:03:25',NULL),('statement_truncate_len','64','2025-12-02 14:03:25',NULL);
...
-- Dump completed on 2026-01-02 15:54:11
-- MySQL dump 10.13  Distrib 8.0.44, for Win64 (x86_64)
--
-- Host: localhost    Database: chefwallet
-- ------------------------------------------------------
-- Server version	8.0.44
...
--
-- Table structure for table `chefwallet`
--

DROP TABLE IF EXISTS `chefwallet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `chefwallet` (
  `idchefwallet` int NOT NULL AUTO_INCREMENT,
  `chefwallet.users` varchar(45) NOT NULL,
  `chefwallet.comments` varchar(45) DEFAULT NULL,
  `chefwallet.emails` varchar(45) DEFAULT NULL,
  `chefwallet.passwords` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idchefwallet`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `chefwallet`
--

LOCK TABLES `chefwallet` WRITE;
/*!40000 ALTER TABLE `chefwallet` DISABLE KEYS */;
/*!40000 ALTER TABLE `chefwallet` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `comments` VALUES (1,1,5,'jflkej','2025-12-02 22:02:40'),(2,1,5,'tre','2025-12-02 22:57:58'),(3,2,5,'ewrwerwe','2025-12-02 23:44:21'),(4,2,1,'erewr3456','2025-12-02 23:44:30'),(5,3,4,'ben crk40','2025-12-03 12:17:28'),(6,4,5,'dfghjklş','2025-12-07 22:26:42'),(7,4,2,'ceyceyceybunuceyenmedi','2025-12-07 22:27:33'),(8,4,5,'hi','2025-12-12 07:42:44'),(9,4,5,'ceyyec','2025-12-12 13:47:39'),(10,6,5,'bendani','2025-12-12 13:53:00'),(11,6,5,'hi','2025-12-15 08:53:56'),(12,4,5,'fghff','2025-12-21 19:49:26'),(13,4,5,'slm','2025-12-26 10:38:46'),(14,7,5,'Kahveli tarifler de bekliyorum :D','2025-12-26 10:52:33'),(15,9,4,'ben hukuk okuyorum','2025-12-26 11:15:26'),(16,4,3,'tarif','2025-12-27 11:32:38'),(17,4,5,'ghjgh','2025-12-28 14:03:58'),(18,10,5,'fgnldf','2025-12-29 11:10:28');
...
INSERT INTO `kategoriler` VALUES (1,'meyve','Meyve & Sebze'),(2,'sut','Süt Ürünleri'),(3,'kahvalti','Kahvaltılık'),(4,'temel','Temel Gıda'),(5,'et','Et-Balık-Tavuk'),(6,'baharat','Baharatlar'),(7,'atıstırmalık','Atıştırmalık'),(8,'icecek','İçecek'),(9,'pratik','Pratik Yemek'),(10,'ev','Ev Ürünleri');
...
CREATE TABLE `sepet` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `sepet_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `sepet` VALUES (4,1,'10',1,'2025-12-26 11:24:30'),(46,10,'38',1,'2025-12-29 11:11:03');
...
INSERT INTO `tarifler` VALUES (1,'Kabak Kavurma Tarifi','Kabak, havuç, soğan, zeytinyağı, karabiber, tuz, yoğurt, dereotu, sarımsak, ceviz içi, toz kırmızı biber','Yoğurtlu ve cevizli kabak kavurma tarifi.','images/kabak-kavurma.jpg','2025-12-28 13:53:16'),(2,'Mantar Yemeği','Mantar, tereyağı, zeytinyağı, sarımsak, tuz, karabiber','Pratik ve lezzetli mantar yemeği.','images/mantar-yemegi.jpg','2025-12-28 13:53:16'),(3,'Fırında Bütün Karnabahar','Karnabahar, hardal, köri, toz kırmızı biber, karabiber, toz sarımsak, tuz, tereyağı, maydanoz','Baharatlı ve fırında pişirilmiş bütün karnabahar.','images/firinda-karnabahar.jpg','2025-12-28 13:53:16'),(4,'Palamut Buğulama','Palamut balığı, mor soğan, beyaz soğan, yeşil biber, sarımsak, domates, limon, zeytinyağı, karabiber, tuz, su, defne yaprağı, tereyağı','Sebzelerle birlikte buğulama palamut tarifi.','images/palamut-bugulama.jpg','2025-12-28 13:53:16'),(5,'Fırında Kabak','Kabak, zeytinyağı, pul biber, tuz, karabiber, dereotlu yoğurt','Hafif ve sağlıklı fırında kabak tarifi.','images/firinda-kabak.jpg','2025-12-28 13:53:16'),(6,'Ratatouille Tarifi','Zeytinyağı, soğan, kapya biber, domates, taze kekik, toz şeker, tuz, karabiber, sarımsak, kabak, patlıcan','Fransız mutfağından klasik ratatouille tarifi.','images/ratatouille.jpg','2025-12-28 13:53:16'),(7,'Zeytinyağlı Enginar','Zeytinyağı, kuru soğan, patates, havuç, bezelye, enginar, limon suyu, su, toz şeker, tuz, dereotu','Klasik Ege usulü zeytinyağlı enginar.','images/zeytinyagli-enginar.jpg','2025-12-28 13:53:16'),(8,'Elma Cacığı ve Közlenmiş Patlıcan','Zeytinyağı, sarımsak tozu, soğan tozu, patlıcan, nane, reyhan, dereotu, fesleğen, sarımsak, dolmalık fıstık, kırmızı biber, domates püresi, kurutulmuş domates, tuz, yeşil elma, süzme yoğurt, turna yemişi','Elma cacığı eşliğinde közlenmiş patlıcan mezesi.','images/elma-cacigi.jpg','2025-12-28 13:53:16');
...
INSERT INTO `urunler` VALUES (1,'ev','bulasik-deterjani','Bulaşık Deterjanı',60.00,'Limon kokulu deterjan',25,'images/bd.jpg',NULL),(2,'ev','camasir-suyu','Çamaşır Suyu',35.00,'Güçlü dezenfektan',30,'images/cs.jpg',NULL),(3,'ev','yumusatici','Yumuşatıcı',50.00,'Mis kokulu yumuşatıcı',20,'images/y.jpg',NULL),(4,'ev','camasir-deterjani2','Çamaşır Deterjanı',75.00,'Renkli ve beyazlar için',18,'images/deterjan.jpg',NULL),(5,'ev','temizlik-bezi','Temizlik Bezi',15.00,'Mikrofiber bez',40,'images/bez.jpg',NULL),(6,'ev','cop-poseti','Çöp Poşeti',22.00,'Büyük boy çöp poşeti',35,'images/poset.jpg',20),(7,'ev','sunger','Sünger',10.00,'Çift taraflı sünger',50,'images/sun.jpg',NULL),(8,'ev','kagit-havlu','Kağıt Havlu',28.00,'Çift katlı havlu',45,'images/havlu.jpg',NULL),(9,'atıstırmalık','cips','Cips',25.00,'Patates cipsi',40,'images/ac.jpg',NULL),(10,'atıstırmalık','cikolata','Çikolata',18.00,'Sütlü çikolata',50,'images/ciko.jpg',NULL),(11,'atıstırmalık','biskuvi','Bisküvi',12.00,'Kakaolu bisküvi',60,'images/bis.jpg',NULL),(12,'atıstırmalık','kraker','Kraker',10.00,'Tuzlu kraker',45,'images/kra.jpg',NULL),(13,'atıstırmalık','findik','Fındık',75.00,'Taze iç fındık',25,'images/fındık.jpg',NULL),(14,'atıstırmalık','badem','Badem',80.00,'Kavrulmuş badem',20,'images/badem.jpg',NULL),(15,'atıstırmalık','kuru-uzum','Kuru Üzüm',35.00,'Tatlı kuru üzüm',30,'images/uzum.jpg',20),(16,'atıstırmalık','cerez-karisik','Çerez Karışık',60.00,'Fındık, fıstık ve kaju',15,'images/cerez.jpg',NULL),(17,'meyve','kabak','Kabak',18.00,'Taze kabak',30,'images/kabak.jpg',NULL),(18,'meyve','havuc','Havuç',12.00,'Taze havuç',40,'images/havuç.jpg',20),(19,'meyve','sogan','Soğan',10.00,'Kuru soğan',50,'images/kurusogan.jpg',NULL),(20,'meyve','mor-sogan','Mor Soğan',14.00,'Taze mor soğan',35,'images/morsogan.jpg',20),(21,'meyve','kapya-biber','Kapya Biber',22.00,'Lezzetli kapya biber',25,'images/kapyabiber.jpg',NULL),(22,'meyve','patlican','Patlıcan',25.00,'Bostan patlıcan',20,'images/patlıcan.jpg',NULL),(23,'meyve','karnabahar','Karnabahar',30.00,'Taze karnabahar',15,'images/karnabahar.jpg',NULL),(24,'meyve','mantar','Mantar',28.00,'Kültür mantarı',20,'images/mantar.jpg',NULL),(25,'meyve','domates','Domates',15.00,'Taze domates',45,'images/domates.jpg',NULL),(26,'meyve','patates','Patates',13.00,'Taze patates',60,'images/patates.jpg',NULL),(27,'meyve','bezelye','Bezelye',20.00,'Dondurulmuş bezelye',30,'images/bezelye.jpg',NULL),(28,'meyve','enginar','Enginar',35.00,'Taze enginar',18,'images/enginar.jpg',NULL),(29,'meyve','limon','Limon',5.00,'Sulu limon',70,'images/limon.jpg',NULL),(30,'meyve','elma','Elma',14.00,'Tatlı elma',40,'images/elma.jpg',NULL),(31,'meyve','turna-yemisi','Turna Yemişi',55.00,'Kurutulmuş turna yemişi',15,'images/turna.jpg',20),(32,'meyve','maydanoz','Maydanoz',6.00,'Taze maydanoz',50,'images/maydanoz.jpg',NULL),(33,'meyve','dereotu','Dereotu',7.00,'Taze dereotu',40,'images/dereotu.jpg',NULL),(34,'meyve','taze-nane','Taze Nane',8.00,'Ferahlık veren nane',35,'images/tazenane.jpg',NULL),(35,'meyve','reyhan','Reyhan Otu',9.00,'Taze reyhan',20,'images/reyhan.jpg',NULL),(36,'meyve','feslegen','Fesleğen',9.00,'Taze fesleğen',20,'images/feslegen.jpg',NULL),(37,'sut','sut','Süt',30.00,'Günlük taze süt',40,'images/süt.jpg',NULL),(38,'sut','peynir','Peynir',85.00,'Tam yağlı beyaz peynir',20,'images/peynir.jpg',20),(39,'sut','tereyagi','Tereyağı',120.00,'Doğal köy tereyağı',15,'images/tereyag.jpg',NULL),(40,'sut','krema','Krema',55.00,'Pastalar için süt kreması',18,'images/krema.jpg',NULL),(41,'sut','kaymak','Kaymak',70.00,'Geleneksel manda kaymağı',10,'images/kaymak.jpg',20),(42,'sut','labne','Labne',45.00,'Yumuşak labne peyniri',22,'images/labne.jpg',NULL),(43,'sut','kefir','Kefir',38.00,'Probiyotik içecek',30,'images/kefir.jpg',NULL),(44,'sut','suzme-yogurt','Süzme Yoğurt',50.00,'250gr Süzme Yoğurt',35,'images/yogurt.jpg',NULL),(45,'sut','krem','Krem Peynir',6.00,'Ağızda ipeksi tat',53,'images/krem.jpg',NULL),(46,'et','palamut','Palamut',95.00,'Taze Karadeniz palamudu',15,'images/palamut.jpg',20),(47,'et','somon','Somon',180.00,'Izgaralık taze somon',10,'images/somon.jpg',NULL),(48,'et','hamsi','Hamsi',75.00,'Karadeniz hamsisi',25,'images/hamsi.jpg',NULL),(49,'et','tavuk_gogus','Tavuk Göğsü',110.00,'Kemiksiz tavuk göğsü',20,'images/tavukg.jpg',NULL),(50,'et','tavuk_kanat','Tavuk Kanat',95.00,'Marine edilmiş kanat',18,'images/tavukk.jpg',NULL),(51,'et','kirmizi_et','Kırmızı Et',260.00,'Dana kuşbaşı',12,'images/et.jpg',NULL),(52,'et','antrikot','Antrikot',320.00,'Izgaralık antrikot',8,'images/ant.jpg',NULL),(53,'et','sucuk','Sucuk',140.00,'Doğal fermente sucuk',14,'images/sucuk.jpg',NULL),(54,'temel','zeytinyagi','Zeytinyağı',150.00,'Soğuk sıkım',10,'images/zeytinyag.jpg',NULL),(55,'temel','domates-puresi','Domates Püresi',25.00,'Hazır domates püresi',20,'images/domatesp.jpg',NULL),(56,'temel','limon-suyu','Limon Suyu',18.00,'Doğal limon suyu',30,'images/limons.jpg',NULL),(57,'temel','toz-seker','Toz Şeker',40.00,'Kristal şeker',50,'images/tozseker.jpg',20),(58,'temel','un','Un',60.00,'Çok amaçlı beyaz un',40,'images/bugday.jpg',NULL),(59,'temel','ekmek','Ekmek',12.00,'Taze ekmek',60,'images/ekmek.jpg',NULL),(60,'temel','pirinc','Pirinç',55.00,'Baldo pirinç',35,'images/pirnc.jpg',NULL),(61,'temel','makarna','Makarna',22.00,'Burgulu makarna',45,'images/makarna.jpg',20),(62,'kahvalti','ceviz-ici','Ceviz İçi',120.00,'Taze ceviz',10,'images/ceviz.jpg',NULL),(63,'kahvalti','dolmalik-fistik','Dolmalık Fıstık',90.00,'Çam fıstığı',8,'images/fıstık.jpg',NULL),(64,'kahvalti','hardal','Hardal',30.00,'Sarı hardal sos',15,'images/hardal.jpg',NULL),(65,'kahvalti','bal','Bal',95.00,'Doğal çiçek balı',12,'images/bal.jpg',NULL),(66,'kahvalti','recel','Reçel',45.00,'Çilek reçeli',18,'images/recel.jpg',NULL),(67,'kahvalti','zeytin','Zeytin',55.00,'Siyah sele zeytin',25,'images/zeytin.jpg',NULL),(68,'kahvalti','salam','Salam',75.00,'Dilimlenmiş dana salam',20,'images/salam.jpg',NULL),(69,'kahvalti','tahin','Tahin',70.00,'Doğal susam tahini',14,'images/tahin.jpg',NULL),(70,'baharat','karabiber','Karabiber',18.00,'Toz karabiber',40,'images/kbiber.jpg',20),(71,'baharat','pul-biber','Pul Biber',15.00,'Acı pul biber',35,'images/pbiber.jpg',NULL),(72,'baharat','kekik','Kekik',14.00,'Dağ kekiği',25,'images/kekik.jpg',NULL),(73,'baharat','kori','Köri',22.00,'Aromalı köri',20,'images/kori.jpg',NULL),(74,'baharat','kirmizi-biber','Kırmızı Biber',16.00,'Toz biber',30,'images/tbiber.jpg',20),(75,'baharat','sarmisak-tozu','Sarımsak Tozu',20.00,'Toz sarımsak',20,'images/stozu.jpg',NULL),(76,'baharat','sogan-tozu','Soğan Tozu',18.00,'Toz soğan',25,'images/toz.jpg',20),(77,'baharat','defne','Defne Yaprağı',10.00,'Kurutulmuş',30,'images/defne.jpg',NULL),(78,'baharat','tuz','Tuz',5.00,'Kaya tuzu',24,'images/tuz.jpg',NULL),(79,'icecek','su','Su',5.00,'Doğal kaynak suyu',100,'images/su.jpg',NULL),(80,'icecek','maden-suyu','Maden Suyu',10.00,'Doğal mineralli',60,'images/msu.jpg',NULL),(81,'icecek','soda-limon','Limonlu Soda',12.00,'Ferahlık veren soda',50,'images/lsoda.jpg',NULL),(82,'icecek','cola','Kola',18.00,'Soğuk içim kola',40,'images/kola.jpg',NULL),(83,'icecek','portakal-suyu','Portakal Suyu',22.00,'Taze sıkım portakal suyu',30,'images/psuyu.jpg',NULL),(84,'icecek','soguk-cay','Soğuk Çay',20.00,'Şeftalili soğuk çay',35,'images/scay.jpg',NULL),(85,'icecek','kahve','Kahve',25.00,'Hazır granül kahve',45,'images/kahve.jpg',NULL),(86,'icecek','yesil-cay','Yeşil Çay',18.00,'Poşet yeşil çay',55,'images/ycay.jpg',NULL);
...
INSERT INTO `users` VALUES (1,'chefata','aaaa@aaaa.com','$2b$10$5N8jGhIMCyxRmaoIWzIw5um9SLzo1bXUtedIZZbOBnyLIWflQySIm','2025-12-02 21:58:14',NULL,NULL,'/uploads/1766748241837-Steve.jpg'),(2,'kimbu','bbb@bbb.com','$2b$10$mY2Tn9BodBa9Bac5XsGJ1..roKnMDP04tRBYfN5RWelixVWJgbH5u','2025-12-02 23:01:51',NULL,NULL,NULL),(3,'crk40','abcd@abcd.com','$2b$10$zxnMPmbJW95CvVuPZf2OMO/jV.G4U19hqCnbsQZS1bl6lfRQ39Y96','2025-12-03 12:15:42',NULL,NULL,NULL),(4,'cey','ccc@ccc.com','$2b$10$dWimxHzi/jogKgPunO3xw.yqZ51p1Sty3u34OxEBtXMX7/n4XPwv.','2025-12-07 14:40:55','05555555555','ahievranüni','/uploads/1767005023896-Jake.png'),(5,'yusufi','fehlfk@flkjd.com','$2b$10$PDB1Flb8YWj5oia.HrJIYOfrJHBIXTj5yot4taBK41cgmt6ZvPH42','2025-12-08 07:39:10',NULL,NULL,NULL),(6,'dani','dddd@dddd.com','$2b$10$osfkoqP7CErP7XlyArxVVe.RcDzBG/wJWp2PMjKClsJm2Htpx0CeS','2025-12-12 13:52:09',NULL,NULL,NULL),(7,'Espresso.','espresso@esp.com','$2b$10$XnfkPHNLcvRkurp8eRXqW.WsTrbyfLVF5WGatxIpbQsNJHUyz.uEe','2025-12-21 23:28:19','05479621652','Napcan ki adresi??','/uploads/1766746936460-Ekran gÃ¶rÃ¼ntÃ¼sÃ¼ 2024-10-16 004123.png'),(8,'golden','golden@golden.com','$2b$10$AxGnVetPa/0QJJEgsaUhBuZyt13j/IpwNcBsh3qHCGhg0Wj8.xNDC','2025-12-24 22:07:22','05555555554','kaüe mmf','/uploads/1766614068147-Steve.jpg'),(9,'awin','awin@awin.com','$2b$10$IgUJagEYV3JjTaMS3X8KougZs0TgwuJUAQ8pQuKpEolbtGo8kFwk2','2025-12-26 11:14:56',NULL,NULL,'/images/default-avatar.png'),(10,'ali','ali@ali.com','$2b$10$yejOYdaVo1zl7SnWL90GnunAadZt.sFnRMuJ2bJTHOdgKW0i6.lsa','2025-12-29 10:56:24',NULL,NULL,'/images/default-avatar.png');
